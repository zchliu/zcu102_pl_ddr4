...
HD_PWD='/home/zchliu/work/Vivado_Project/zcu102_pl_ddr4/zcu102_pl_ddr4.runs/fifo_ddr4_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ddr4_buf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ddr4_buf.tcl
